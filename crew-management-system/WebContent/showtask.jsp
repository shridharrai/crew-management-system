  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 overflow-auto mb-5">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Existing Tasks</h1>
      </div>
<div class='w-100 float-right pr-2'>
<%@page import="java.util.ArrayList,com.shubham.webapp.dto.taskDTO"%>
	...
	<table class='table table-bordered'>
			...
			<tbody>
				<%
				ArrayList<taskDTO> tasklist = (ArrayList<taskDTO>)request.getAttribute("taskdata");
				
					if(tasklist!=null){
						for(taskDTO obj : tasklist){
